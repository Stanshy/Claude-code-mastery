...
⬅️ [上一章：Agent = Model + Harness](../02-基礎配置/02-3-Agent等於Model加Harness.md) ｜ 📖 [回目錄](../00-索引與摘要.md) ｜ ➡️ [下一章：Hooks 進階與 Validator 模式](03-2-Hooks進階與Validator模式.md)

🌐 [English Version](../../en/03-automation/03-1-hooks-basics.md)
