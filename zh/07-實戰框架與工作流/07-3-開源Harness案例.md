...
⬅️ [上一章：gstack 角色系統](07-2-gstack角色系統.md) ｜ 📖 [回目錄](../00-索引與摘要.md) ｜ ➡️ [下一章：David Chu 進化框架](07-4-David-Chu進化框架.md)

🌐 [English Version](../../en/07-frameworks/07-3-open-source-cases.md)
